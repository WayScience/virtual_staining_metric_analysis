...
normalized_metric_results.to_parquet(
    analysis_output_dir / "normalized_metric_results.parquet",
    index=False,
    compression="zstd",
)
...
# ## Outputs
#
# Notebook 1.10 reads `configuration.json`, `metric_results.parquet`, `normalized_metric_results.parquet`, the reference TIFF, and per-transform snapshots from the channel-specific analysis directory.
