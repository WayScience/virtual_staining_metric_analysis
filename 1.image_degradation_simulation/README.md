...
- L1 (MAE)
And created foreground masked variants of SSIM and PSNR, inspired by the foreground aware training objective in Kalinin et. al (10.48550/arXiv.2507.05383):
- Foreground SSIM
- Foreground PSNR
